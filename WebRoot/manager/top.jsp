...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="skin/images/frame/topbg.gif">
  <tr>
    <td width='20%' height="60" style="font-size: 24px;font-weight: bold;margin-left: 10px;">购茶网后台管理系统</td>
    <td width='80%' align="right" valign="bottom">
	  ...
	  <font style="color:green;font-weight: bold">
				...
				您好！欢迎光临茗茶购物网 <a href="../com.zhbit.action/userExitAction.action?userType=manager">安全退出</a>
      </td>
      </tr>
      <tr>
